...
from app.api.v1.endpoints import auth, auditoria, compras, configuracion, contabilidad, facturacion, garantias, inventario, laboratorio, nomina, productos, reportes, usuarios, ventas
